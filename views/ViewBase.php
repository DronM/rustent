...
if (file_exists('models/MainMenu_Model_production.php')){
...
class ViewBase extends ViewHTMLXSLT {	
	...
	(!isset($_SESSION['locale_id']) && DEF_LOCALE=='ru')
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'forms/DocOrder_Form.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'views/ColorList_View.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'views/DocOrderStateHistList_View.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'custom_controls/AppRustent.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'custom_controls/ColorEditRef.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'custom_controls/DocOrderEditRef.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'custom_controls/DocOrderValubleGrid.js'));
	...
	(!isset($_SESSION['locale_id']) && DEF_LOCALE=='ru')
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'custom_controls/ColorNameEdit.js'));
	...
	(!isset($_SESSION['locale_id']) && DEF_LOCALE=='ru')
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'controllers/Color_Controller.js'));
		...
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/Color_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/Metarial_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrder_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderState_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'enum_controls/Enum_doc_order_states.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'enum_controls/EnumGridColumn_doc_order_states.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'controllers/DocOrderStateHist_Controller.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderStateHist_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderList_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderStateHistList_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/Material_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderDialog_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'controllers/DocOrderValuble_Controller.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderValuble_Model.js'));
		$this->addJsModel(new ModelJavaScript(USER_JS_PATH.'models/DocOrderAttachment_Model.js'));
