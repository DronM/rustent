...
function DocOrderState_Model(options){
	var id = 'DocOrderState_Model';
	options = options || {};
	...
	filed_options.enumValues = 'accept,production,ready';
	...
	options.fields.user_id.getValidator().setRequired(true);
		...
		DocOrderState_Model.superclass.constructor.call(this,id,options);
}
