...
function DocOrder_Model(options){
	var id = 'DocOrder_Model';
	options = options || {};
	...
	options.fields.order_name.getValidator().setRequired(true);
	...
	options.fields.color_id = new FieldInt("color_id",filed_options);
	...
	options.fields.ready_date = new FieldDate("ready_date",filed_options);
		...
		DocOrder_Model.superclass.constructor.call(this,id,options);
}
