...
DocOrderDialog_View.prototype.printOrderCont=function(){var contr=this.getController();var pm=contr.getPublicMethod("get_files_list");pm.setFieldValue("doc_order_id",this.getElement("id").getValue());var self=this;pm.run({"ok":function(resp){var offset=0;var h=$(window).width()/3*2;var left=$(window).width()/2;var w=left-20;var pm=contr.getPublicMethod("get_print");pm.setFieldValue("doc_order_id",self.getElement("id").getValue());pm.setFieldValue("templ","DocOrderPrint");pm.setFieldValue("inline","1");contr.openHref("get_print","ViewPDF","location=0,menubar=0,status=0,titlebar=0,top="+(50+offset)+",left="+(left+offset)+",width="+w+",height="+h);}});}
...
extend(DocOrderPrintOrderBtn,ButtonCmd);DocOrderPrintOrderBtn.prototype.print=function(){var contr=new DocOrder_Controller();var pm=contr.getPublicMethod("get_files_list");pm.setFieldValue("doc_order_id",this.m_getDocOrderId());var self=this;pm.run({"ok":function(resp){var offset=0;var h=$(window).width()/3*2;var left=$(window).width()/2;var w=left-20;var pm=contr.getPublicMethod("get_print");pm.setFieldValue("doc_order_id",self.m_getDocOrderId());pm.setFieldValue("templ","DocOrderPrint");pm.setFieldValue("inline","1");contr.openHref("get_print","ViewPDF","location=0,menubar=0,status=0,titlebar=0,top="+(50+offset)+",left="+(left+offset)+",width="+w+",height="+h);}});} 
